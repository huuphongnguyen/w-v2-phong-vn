...
const url = "https://phong.vn//domains/emb.vn";
const title = "Domains - emb.vn – PHONG FOUNDATION";
const description =
  "Tên miền emb.vn hiện tại thuộc quyền sở hữu của PHONG FOUNDATION. Mình làm thêu là chính nên đây là một tên miền mình rất thích. EMB là viết tắt của Embroidery và cũng là ký tự đại diện cho file .EMB - một loại sfile thiết kế quan trọng bậc nhất trong lĩnh vực thêu";
const domainname = "emb.vn";
const domaindes =
