...
const description =
  "Tên miền riot.vn hiện tại thuộc quyền sở hữu của PHONG FOUNDATION. Mình từng có ý tưởng xây dựng một local brand cho các bạn yêu thích thể thao điện tử và có phần năng động, dựa trên tên của 1 trong những nhà làm game đỉnh nhất hiện nay là RIOT Games. Cuối cùng vì bận và một vài lý do cá nhân mình đã chưa kịp làm. Giờ thì cũng hết cảm hứng luôn rồi.";
