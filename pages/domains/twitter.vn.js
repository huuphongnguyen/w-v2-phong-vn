...
const url = "https://phong.vn/domains/twitter.vn";
const title = "Domains - twitter.vn – PHONG FOUNDATION";
const description =
  "Tên miền twitter.vn hiện tại thuộc quyền sở hữu của PHONG FOUNDATION. Một tên miền Việt Nam của mạng xã hội Twitter. Mình cũng không nhớ tại sao mình có thể mua domain này luôn. *mặt ngơ";
const domainname = "twitter.vn";
const domaindes =
