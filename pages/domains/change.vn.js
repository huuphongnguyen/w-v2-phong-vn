...
const url = "https://phong.vn//domains/change.vn";
const title = "Domains - change.vn – PHONG FOUNDATION";
const description =
  "Tên miền change.vn hiện tại thuộc quyền sở hữu của PHONG FOUNDATION. Thay đổi là cách duy nhất để tồn tại. Mình đã từng sống vì câu nói ấy, và muốn thực hiện 1 điều đặc biệt trên tên miền này.";
const domainname = "change.vn";
const domaindes =
