...
const description =
  "Tên miền anonymous.vn hiện tại thuộc quyền sở hữu của PHONG FOUNDATION. Nghe như Hacker đúng không? *cười. Mình có một ý tưởng trên tên miền này, tất nhiên là không làm gì phạm pháp rồi. Một ý tưởng khá hay đã xuất hiện nhưng không phải là lúc này.";
const domainname = "anonymous.vn";
const domaindes =
